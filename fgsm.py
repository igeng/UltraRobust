...
#图像加载以及预处理
image_path="/home/igeng/Downloads/adversarial_examples-master/select1000_new/14.png"
...
model_urls = {'alexnet': '/home/igeng/Downloads/adversarial_examples-master/pretrainedmodel/alexnet/alexnet-owt-4df8aa71.pth'}
#使用预测模式 主要影响droupout和BN层的行为
# model = models.alexnet(pretrained=True).to(device).eval()
model = models.alexnet(pretrained=False).to(device).eval()
